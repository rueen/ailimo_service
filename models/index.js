...
db.CageRoom = require('./CageRoom')(sequelize);
...
db.Cage.belongsTo(db.CageRoom, { foreignKey: 'room_id', as: 'room' });
...
db.CageReservation.belongsTo(db.CageRoom, { foreignKey: 'room_id', as: 'room' });
