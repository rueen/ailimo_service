...
```json
{
  ...
  "data": {
    ...
    "last_login_time": "2026-01-07 15:30:00",
...
```json
{
  "old_password": "123456",     // 必填，旧密码
  "new_password": "newpass123"  // 必填，新密码（6-20位，包含字母和数字）
}
```
...
{
  "name": "笼位管理员",                    // 必填，角色名称
  "description": "负责笼位预约管理",       // 可选，角色描述
  "permission_ids": [10, 11, 12]          // 必填，权限ID数组
}
```
...
```json
{
  ...
  "permission_ids": [10, 11, 12, 13]  // 可选，权限ID数组
}
```
