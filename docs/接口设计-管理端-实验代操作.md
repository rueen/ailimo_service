    ...
    "list": [
      {
        ...
        "time_slots": ["2026-01-10 09:00-12:00", "2026-01-11 09:00-12:00"],
        "status": 0,
        "remark": "需要进行灌胃操作",
        "handler": null,
        "reject_reason": null,
...
```json
{
  "operation_content_id": 1,                                                               // 可选，操作内容ID
  "animal_type_id": 1,                                                                     // 可选，动物类型ID
  "quantity": 25,                                                                        // 可选，动物数量
  "user_id": 10,                                                                          // 可选，预约用户ID
  "time_slots": ["2026-01-10 09:00-12:00", "2026-01-11 09:00-12:00"],                   // 可选，预约时间段数组（日期+时间段）
  "remark": "备注信息"                                                                   // 可选，备注
}
```
...
```json
{
  ...
  "data": {
    ...
    "completed": 50,             // 已完成
    "cancelled": 5,              // 已取消
    "operation_ranking": [        // 操作内容排行
      {
        "operation_content_id": 1,
        "operation_content_name": "灌胃",
        "count": 30
      }
    ],
    "animal_type_ranking": [       // 动物类型排行
      {
        "animal_type_id": 1,
        "animal_type_name": "小鼠",
        "count": 50
