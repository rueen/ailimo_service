...
```json
{
  ...
  "reservation_date": "2026-01-10",  // 可选，预约日期筛选（查询包含该日期的订单）
  "start_date": "2026-01-01",        // 可选，预约日期范围开始（查询包含该日期的订单）
  "end_date": "2026-01-31"           // 可选，预约日期范围结束（查询包含该日期的订单）
}
```
    ...
    "list": [
      {
        ...
        "time_slots": ["2026-01-10 09:00-10:00", "2026-01-10 10:00-11:00"],
        "status": 0,
      ...
      },
      {
        ...
        "time_slots": ["2026-01-12 14:00-15:00", "2026-01-13 09:00-10:00"],
        "status": 1,
        "remark": null,
        "handler": {
          "id": 1,
...
```json
{
  ...
  "data": {
    ...
    "time_slots": ["2026-01-10 09:00-10:00", "2026-01-10 10:00-11:00", "2026-01-11 14:00-15:00"],
    "status": 1,
    "remark": "需要使用显微镜进行细胞观察",
    "handler": {
      "id": 2,
...
```json
{
  ...
  "time_slots": ["2026-01-10 09:00-10:00", "2026-01-10 10:00-11:00", "2026-01-11 09:00-10:00"],  // 可选，预约时间段数组（日期+时间段）
  "remark": "备注信息"                                                           // 可选，备注
}
```
...
3. 从订单的 time_slots JSON 字段中提取指定日期的时间段
4. 计算可用时间段（时间段配置中排除已预约的）
